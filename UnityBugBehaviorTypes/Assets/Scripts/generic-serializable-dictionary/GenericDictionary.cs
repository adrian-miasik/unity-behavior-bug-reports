...
#pragma warning restore 0414
        ...
        /// <summary>
        /// Default constructor. Blank dictionary.
        /// </summary>
        ...
        /// <summary>
        /// Copy constructor. Creates a new dictionary using the provided dictionary data.
        /// </summary>
        /// <param name="dictionary"></param>
        public GenericDictionary(Dictionary<TKey, TValue> dictionary)
        {
            // Verify
            if (dictionary == null)
            {
                Debug.LogWarning("Unable to initialize using provided dictionary data. Provided dictionary is null.");
                return;
            }
            ...
            // Populate internal dictionary using provided data.
            foreach (KeyValuePair<TKey, TValue> kvp in dict)
            {
                list.Add(new KeyValuePair(kvp.Key, kvp.Value));
                indexByKey[kvp.Key] = list.Count - 1;
            }
        }
